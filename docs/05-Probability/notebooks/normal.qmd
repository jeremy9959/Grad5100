...
ggplot()+geom_histogram(aes(x=data,y=..density..),binwidth=.1) +
...
ggplot()+geom_line(aes(x=seq(-3,3,length.out=100),y=normal,color="Normal"))+geom_line(aes(x=seq(-3,3,length.out=100),y=student, color="t"))+scale_color_manual(values=c("Normal"="blue","t"="red")) +
...
plt<-ggplot()+geom_histogram(aes(x=data50,y=..density..),binwidth=.1) +
...
ggplot()+geom_histogram(aes(x=var_samples, y=..density..),bins=25) +
    labs(title="Distribution of variance of 10 element samples from standard normal")
```
...
ggplot()+geom_histogram(aes(x=var_samples, y=..density..),bins=50) +
    labs(title="Distribution of sd of 10 element samples from standard normal")
```
