...
We are going to use the following little command to send SQL to the database
...
refers to the first letter of the last_name.  Retrieve all the actors whose last name starts with "A".
5. Do problem 4, but sort them in alphabetical order by their first name.
