...
![Sakila Database ER Diagram ([from the MySQL Documentation](https://docs.oracle.com/cd/E17952_01/workbench-en/wb-documenting-sakila.html))](img/wb-sakila-eer.png)
...
![Installing via Anaconda Navigator](./img/pymysql.png)
...
To work through some examples using both `python` and `R`:

- [SQL and Python](sql_python.qmd)
- [SQL and R](sql_r.qmd)

A key concept in working with databases (and tabular data generally) is the notion
of a `join`.  We look at `joins` here:

- [Joins (examples in Python)](sql_joins.qmd)
- [Joins (examples in R)](sql_joins_r.qmd)

A few additional topics (HAVING and WITH) are discussed [here](sql_additional.qmd).