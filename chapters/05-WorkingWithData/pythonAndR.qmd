...
- [R/basics of R programming](r_programming.qmd)
- [R/tidyverse walkthrough](r_penguins.qmd)
- [Python/basics of python programming](python_programming.qmd)
- [Python/pandas walkthrough](pandas_penguins.qmd)

To download the materials including the data so you can work with them 
locally, [follow this link](programming.zip).
