...
For the R part of the homework (problems 1 and 2), you submit a QMD file with the following YAML material at the top.  For the Python part (problem 3) submit an ipynb file. 
...
3. Write an R function that takes a string as input, removes all characters that are not
...
5.  If $x_0=1$ and $n$ is a positive real number, the iteration
$$
