...
axes = fig.add_subplot(1,1,1)  # here we are saying the figure will have 1 row, 1 column, and this is plot number 1.
...
axes4 = fig.add_subplot(2,2,4)
axes1.plot(x,y)
axes2.scatter(penguins['Body Mass (g)'],penguins['Flipper Length (mm)'],s=.1)
...
male_plot = axes.scatter(x=Males['Body Mass (g)'],y=Males['Flipper Length (mm)'],c='blue',label = 'Male')
female_plot = axes.scatter(x=Females['Body Mass (g)'],y=Females['Flipper Length (mm)'],c='red',label = 'Female')
...
for i,x in enumerate(
    ...
    male_plot = axes.scatter(x=Males['Body Mass (g)'],y=Males[x],c='blue',label = 'Male')
    female_plot = axes.scatter(x=Females['Body Mass (g)'],y=Females[x],c='red',label = 'Female')
    axes.legend(["Male","Female"])
fig
```
...
axes.hist(Males['Body Mass (g)'],color='forestgreen',bins=50,density=True,label='Male',alpha=.5)
axes.hist(Females['Body Mass (g)'],color='orange',bins=50,density=True,label='Female',alpha=.5)
axes.legend(['Male','Female'])
fig
```
...
```{python}
sns.relplot(data=penguins,col='Sex',hue='Species',x='Body Mass (g)',y='Flipper Length (mm)')
```

```{python}
ax = sns.relplot(data=penguins,hue='Species',x='Body Mass (g)',y='Flipper Length (mm)')
```
