...
The chain rule is extremely important.
...
You can compute the partial derivatives very simply using calculus rules where you treat all of the variables except $x_{i}$ as constants. 
