...
To see the significance of this, check out [this page](./GDanimate_js.html).  If you click on
a point, the red line traces out a path along the (negative) gradient.
